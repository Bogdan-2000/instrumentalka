...
function rentTool() {
    ...
    modalContent.innerHTML = `
        ...
        <p style="margin-bottom: 2rem;">Віброплита професійна</p>
        <div style="display: grid; gap: 1rem; margin-bottom: 2rem;">
            <input type="text" placeholder="Ваше ім'я" required>
            <input type="tel" placeholder="Номер телефону" required>
            <select>
                <option value="1">1 день - 300 ₴</option>
                <option value="3">3 дні - 850 ₴</option>
                <option value="7">Тиждень - 2000 ₴</option>
                <option value="14">14 днів - 3500 ₴</option>
            </select>
        </div>
...
function submitRental() {
    ...
    formData.append('tool', 'Віброплита професійна');
    formData.append('price', '300 ₴ за добу');
